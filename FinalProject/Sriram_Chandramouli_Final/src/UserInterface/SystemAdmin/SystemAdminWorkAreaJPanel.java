...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        approveConsumerJButton = new javax.swing.JButton();
        ...
        jPanel1.add(manageNetworkJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 143, 265, 32));
        ...
        jPanel1.add(manageAdminJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 327, -1, 35));
        ...
        jPanel1.add(manageEnterpriseJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 234, 265, 35));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Selected Node:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 75, -1, 32));

        selectedNodeJLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        selectedNodeJLabel.setText("<view_selected_node>");
        jPanel1.add(selectedNodeJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(224, 75, 192, 32));

        approveConsumerJButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        approveConsumerJButton.setText("Approve Consumers >>");
        approveConsumerJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                approveConsumerJButtonActionPerformed(evt);
            }
        });
        jPanel1.add(approveConsumerJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 416, 265, 36));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setText("SYSTEMADMIN WORK AREA");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 19, 340, 25));
    ...
    private void approveConsumerJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveConsumerJButtonActionPerformed
        
        
        ConsumerRequestJPanel crjp = new ConsumerRequestJPanel(userProcessContainer,userAccount, system);
        userProcessContainer.add("ApproveConsumers",crjp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
          
    }//GEN-LAST:event_approveConsumerJButtonActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTree JTree;
    private javax.swing.JButton approveConsumerJButton;
